...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="../install/assets/images/favicon.ico" />
        <title>OXOO - Live TV & Movie Portal App Installation</title>
        <link rel='stylesheet' type='text/css' href='../install/assets/bootstrap/css/bootstrap.min.css' />
        <link rel='stylesheet' type='text/css' href='../install/assets/js/font-awesome/css/font-awesome.min.css' />

        <link rel='stylesheet' type='text/css' href='install.css' />

        <script type='text/javascript'  src='../install/assets/js/jquery-1.11.3.min.js'></script>
        <script type='text/javascript'  src='../install/assets/js/jquery-validation/jquery.validate.min.js'></script>
        <script type='text/javascript'  src='../install/assets/js/jquery-validation/jquery.form.js'></script>
        ...
        <div class="install-box">
            ...
            <div class="panel panel-install">
                <div class="panel-heading text-center">                    
                    <h2>OXOO - Live TV & Movie Portal App Installation</h2>
                </div>
                <div class="panel-body no-padding">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="finished-tab">
                            <div class="section">
                                <div class="clearfix">
                                    <i class="status fa fa-check-circle-o pull-left" style="font-size: 50px"> </i><span class="pull-left"  style="line-height: 50px;">Congratulation! You have successfully installed <strong>OVOO - Live TV &amp; Movie Portal App</strong></span>  
                                </div>
