...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/images/bslogo.png">
    <!-- CSS-->
    ...
    <title><?php echo "app.bshevc.org" ?> - Login</title>
  </head>
  <body>
    ...
    <section class="login-content">
      <div class="logo">
        <img src="<?php echo base_url(); ?>assets/images/bslogo.png" alt="bslogo" height="40">        
      </div>
      <div class="login-box">
