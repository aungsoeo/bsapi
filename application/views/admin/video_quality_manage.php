  ...
  <div class="row">
    <div class="col-sm-6">
      <?php echo form_open(base_url() . 'admin/video_quality/add/' , array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data'));?>
        <h4 class="text-center">Add Video Quality</h4>
        <hr>
        <div class="form-group">
          <label class="col-sm-3 control-label">Video Quality</label>
          <div class="col-sm-6">
    ...
    <div class="col-sm-6">
      <h4 class="text-center">Video Quality List</h4>
        <hr>
        <table id="datatable-buttons" class="table table-striped">
          <thead>
            <tr>
              <th>#</th>
              <th>Video Qualilty</th>
              <th>Description</th>
              <th>Option</th>
            </tr>
          </thead>
