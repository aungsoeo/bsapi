  ...
  <div class="row">
    <div class="col-sm-12">
          ...
          <ul class="dropdown-menu" role="menu">
            <li> <a class="dropdown-item" href="<?php echo base_url().'admin/comments/approved'?>">Approved</a></li>
            <li><a class="dropdown-item" href="<?php echo base_url().'admin/comments/unapproved'?>">Unapproved</a></li>
            <li><a class="dropdown-item" href="<?php echo base_url().'admin/comments/trash'?>">Trash</a></li>
            <li><a class="dropdown-item" href="<?php echo base_url().'admin/comments/spam'?>">Spam</a></li>
            <li><a class="dropdown-item" href="<?php echo base_url().'admin/comments/'?>">All</a></li>
          </ul>
        </div>
          <br><br>
          ...
          <tbody>
            ...
            <tr id='row_<?php echo $comments['comments_id'];?>'>                
              <td><div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a class="dropdown-item" data-toggle="modal" data-target="#mymodal" data-id="<?php echo base_url() . 'admin/view_modal/comments_edit/'. $comments['comments_id'].'/movie';?>" id="menu" title="Edit" >Edit Comments</a> 
                    <li><a class="dropdown-item" title="Delete>" href="#" onclick="delete_row(<?php echo " 'comments' ".','.$comments['comments_id'];?>)">Delete</a> </li>
                  </ul>
                </div>
              </td>
              <td><?php echo $sl++;?></td>
