        ...
        <div class="panel panel-border panel-primary">
            ...
            <input type="hidden" id="from" name="from" value="tv">
                <div class="form-group m-b-0">
                    ...
                    <small class="form-text text-muted" id=""><a href="https://youtu.be/DZrv95huYUk" target="_blank">Tutorial | </a> Get TMDb ID from here: <a href="https://www.themoviedb.org/tv/" target="_blank">TheMovieDB.org.</a> </small>
    ...
    <div class="col-md-6">
        <div class="card cta cta--featured p-a">
          <div class="card-block">
            <h3 class="card-title no-margin-top">TV-Series Info</h3>
          </div>
...
<div class="col-md-6">
    <div class="card cta cta--featured p-a">
        <div class="card-block">
        <h3 class="card-title no-margin-top">Additional Info</h3>
      </div>
      <span class="header-line"></span>
        <div class="form-group">
