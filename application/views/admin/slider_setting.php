            ...
            <div class="panel panel-border panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control m-bot15" id="slider_type" name="slider_type">
                                ...
                                <option value="movie" <?php if($this->db->get_where('config' , array('title' =>'slider_type'))->row()->value=='movie'){echo 'selected';}?> id="ad1_code_selection">Latest Movie</option>
                    ...
                    <div id="total_movie_in_slider">
                        <div class="form-group">
                            <label class=" col-sm-6 control-label">Total Movie</label>
                            <div class="col-sm-6">
