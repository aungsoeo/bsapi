...
<body class="app sidebar-mini rtl <?php //if(isset($page_name) && ($page_name=='videos_add' || $page_name=='videos_edit'|| $page_name=='videos_manage')){ echo 'sidebar-collapse';}  ?>">    
    ...
    <header class="app-header hidden-print"><a class="app-header__logo" href="<?php echo base_url(); ?>">
        <img src="<?php echo base_url(); ?>assets/images/bslogo.png" alt="bslogo" height="30" style="margin-top:-15px;"></a>
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><img  src="<?php echo $this->common_model->get_img('user', $this->session->userdata('user_id')).'?'.time();?>" class="img-circle" alt="photo" height="20"></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            <li><a class="dropdown-item" href="<?php echo base_url();?>admin/manage_profile"><i class="fa fa-user fa-lg"></i> Profile</a></li>
            <li><a class="dropdown-item" href="<?php echo base_url();?>admin/manage_profile"><i class="fa fa-lock fa-lg" aria-hidden="true"></i>Change Password</a></li>
    ...
    <footer class="footer text-right"> <?php echo date("Y"); ?> &copy; <a href="https://app.bshevc.org/">app.bshevc.org</a> |
  Developed by: <a href="https://bshevc.org/">BS Admin Team</a></footer>
   <!-- ajax modal  -->
