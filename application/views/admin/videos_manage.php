<div class="row card">
  <div class="col-sm-12">
    <div class="row">
      <div class="col-md-3">
        <a href="<?php echo base_url() . 'admin/videos_add';?>" class="btn btn-sm btn-primary waves-effect waves-light"><span class="btn-label"><i class="fa fa-plus"></i></span>Add Movie</a> <br>
      <br>
      </div>
      <div class="col-md-9">
            ...
            <td>
              <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a class="dropdown-item" href="<?php echo base_url() . 'admin/file_and_download/'. $videos['videos_id'];?>">Manage Videos</a></li>
                  <li><a class="dropdown-item" href="<?php echo base_url() . 'admin/videos_edit/'. $videos['videos_id'];?>">Edit Movie</a></li>
