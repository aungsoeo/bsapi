    ...
    <div class="col-md-12">
      <div class="panel panel-border panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">Footer Setting</h3>
        </div>
        <div class="panel-body"> 
          <!-- panel  -->
          
          <div class="form-group row">
            <label class=" col-sm-3 control-label">Footer-1 Title</label>
            <div class="col-sm-8">
          ...
          <div class="form-group row">
            <label class="control-label col-md-3">Footer-1 Content</label>
            <div class="col-md-8">
          ...
          <div class="form-group row">
            <label class=" col-sm-3 control-label">Footer-2 Title</label>
            <div class="col-sm-8">
          ...
          <div class="form-group row">
            <label class="control-label col-md-3">Footer-2 Content</label>
            <div class="col-md-8">
          ...
          <div class="form-group row">
            <label class=" col-sm-3 control-label">Footer-3 Title</label>
            <div class="col-sm-8">
          ...
          <div class="form-group row">
            <label class="control-label col-md-3">Footer-3 Content</label>
            <div class="col-md-8">
          ...
          <div class="form-group row">
            <label class="control-label col-md-3">Copyright Text</label>
            <div class="col-md-8">
