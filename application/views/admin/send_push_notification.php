    <div class="card">
      <div class="row"> 
        <!-- panel  -->
        <div class="col-md-12">
          <?php echo form_open(base_url() . 'admin/send_push_notification/send/' , array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data'));?> 
          <div class="panel panel-border panel-primary">
            ...
            <div class="panel-body"> 
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" name="headings" class="form-control" value="New Movie Release" required>
                </div>
              </div>
              <div class="form-group row">
                <label class=" col-sm-4 control-label">Message</label>
                <div class="col-sm-8">
                  <textarea type="text" name="message" class="form-control" rows="4" required>Watch free latest movie online.</textarea>
                </div>
              </div>              
