<div class="card">
    <div class="row">
        <div class="col-sm-12">
                <a href="<?php echo base_url() . 'admin/manage_live_tv/new';?>" class="btn btn-sm btn-primary waves-effect waves-light"><span class="btn-label"><i class="fa fa-plus"></i></span>Add Live TV</a>
                <?php if($total_rows >0): ?>
                    <br>
                <br>
                        ...
                        <tr id='row_<?php echo $tv['live_tv_id'];?>'>
                            ...
                            <td><div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                  <li><a class="dropdown-item"  href="<?php echo base_url() . 'admin/manage_live_tv/edit/'. $tv['live_tv_id'];?>">Edit</a></li>
                                  <li><a class="dropdown-item" title="Delete" href="#" onclick="delete_row(<?php echo " 'live_tv' ".','.$tv['live_tv_id'];?>)" class="delete">Delete</a> </li>
                                </ul>
                              </div>
                            </td>
                            <td>
