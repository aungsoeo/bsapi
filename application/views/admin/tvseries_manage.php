<div class="row card">
  <div class="col-sm-12">
    <div class="row">
      <div class="col-md-3">
        <a href="<?php echo base_url() . 'admin/tvseries_add';?>" class="btn btn-sm btn-primary waves-effect waves-light"><span class="btn-label"><i class="fa fa-plus"></i></span>Add Video</a> <br>
      <br>
      </div>
      <div class="col-md-9">
            ...
            <td>
              <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a class="dropdown-item" href="<?php echo base_url() . 'admin/seasons_manage/'. $videos['videos_id'];?>">Seasions &amp; Episods</a></li>
                  <li><a class="dropdown-item" href="<?php echo base_url() . 'admin/tvseries_edit/'. $videos['videos_id'];?>">Edit Tv-Series</a></li>
                  <li><a class="dropdown-item" title="Delete" href="#" onclick="delete_row(<?php echo " 'videos' ".','.$videos['videos_id'];?>)" class="delete">Delete</a> </li>
                  <li><a class="dropdown-item" href="<?php echo base_url() . 'admin/send_movie_notification/push/'. $videos['videos_id'].'/tv';?>">Send Push Notification</a></li>
