...
class Tmdb_model extends CI_Model {
    ...
    function get_movie_info($tmdb_id='')
    {
      ...
      // $data           = file_get_contents('http://ovoo.spagreen.net/scrapper/v20/get_movie_json/'.$purchase_code.'/'.$tmdb_id);
       $data           = file_get_contents('https://api.themoviedb.org/3/movie/'.$tmdb_id.'?api_key=4de8571d2879a4f5acb3a88403f62fa5');
      
	  	$data           = json_decode($data, true);
        
        $data1= file_get_contents('http://api.themoviedb.org/3/movie/'.$tmdb_id.'/casts?api_key=4de8571d2879a4f5acb3a88403f62fa5');
      ...
      // }else{
        ...
        $genres         = array();
        if(count($data) >0){
            $a          = $this->update_actors($data1['cast']);
            $dw         = $this->update_directors_writers($data1['crew']);
            
            $actors        = $this->filter_actors($data1['cast']);
            $directors     = $this->filter_directors($data1['crew']);
            $writters      = $this->filter_writters($data1['crew']);
...
//      $data           = file_get_contents('http://ovoo.spagreen.net/scrapper/v20/get_tvshow_json/'.$purchase_code.'/'.$tmdb_id);
      $data           = file_get_contents('https://api.themoviedb.org/3/tv/'.$tmdb_id.'?api_key=4de8571d2879a4f5acb3a88403f62fa5'.'&append_to_response=credits');
      $data           = json_decode($data, true);
  ...
  function get_movie_actor_info($tmdb_id='')
    {
      ...
      //$data           = file_get_contents('http://ovoo.spagreen.net/scrapper/v20/get_movie_json/xxxxxxxxxx/'.$tmdb_id);
        ...
        $data           =file_get_contents(' http://api.themoviedb.org/3/movie/'.$tmdb_id.'/casts?api_key=4de8571d2879a4f5acb3a88403f62fa5');
  ...
  function import_movie_info($tmdb_id=''){
      ...
      if(isset($data['error_message'])){
        ...
        if(count($data) >0 && $data['title'] !='' && $data['title'] !=NULL){
          ...
          $movie_data['release']        = $data['release'];
